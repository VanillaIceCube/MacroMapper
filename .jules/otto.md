...
**Learning:** Dependabot pull requests (such as #163 updating `djangorestframework` to 3.18.1) are automatically merged into `main` after CI checks pass, without introducing domain logic or backlog scope changes.
